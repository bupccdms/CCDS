...
var widgetsSortable = $.widget( "ui.sortable", $.ui.mouse, {
	...
	_rearrange: function( event, i, a, hardRefresh ) {
		...
		// 2. on the instance, we have a device variable, that get's higher after every append
		// 3. on the local scope, we copy the device variable, and check in the timeout,
		// if it's still the same
		// 4. this lets only the last addition to the timeout stack through
		this.device = this.device ? ++this.device : 1;
...
$.widget( "ui.spinner", {
	...
	_spin: function( step, event ) {
		...
		value = this._adjustValue( value + step * this._increment( this.device ) );
